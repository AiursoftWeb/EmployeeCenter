...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanViewInfrastructure,
                localizer["View Infrastructure"],
                localizer["Allows viewing the server and service registry, deployment relationships, and infrastructure reference data."]),
            new(AppPermissionNames.CanManageInfrastructure,
                localizer["Manage Infrastructure"],
                localizer["Allows creating, updating, retiring, and maintaining servers, services, providers, DNS providers, and domain aliases."]),
            new(AppPermissionNames.CanViewServiceAudit,
                localizer["View Service Audit"],
                localizer["Allows viewing service health summaries, observations, and detailed audit findings."]),
            new(AppPermissionNames.CanRunServiceAudit,
                localizer["Run Service Audit"],
                localizer["Allows manually triggering the service DNS and availability audit."]),
            new(AppPermissionNames.CanManageServices,
                localizer["Manage Services (Legacy)"],
                localizer["Legacy permission retained for transition. Assign Manage Infrastructure to roles that still need access."]),
            new(AppPermissionNames.CanAuditDns,
                localizer["Audit Services (Legacy)"],
                localizer["Legacy permission retained for transition. Assign View Service Audit and Run Service Audit as appropriate."]),
